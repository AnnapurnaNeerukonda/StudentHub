...
function Register() {
  const [isLogin, setIsLogin] = useState(true);
  const [loginData, setLoginData] = useState({ email: '', password: '' });
  const [signupData, setSignupData] = useState({ username: '', email: '', password: '', gender: '' });
  ...
  return (
    <div className="container">
      ...
      <div class="centered-title">Student Smart Hub</div>
        <div className="col-md-6 image-side">
          <img
            src="https://cdn9.dissolve.com/p/D2012_156_013/D2012_156_013_1200.jpg"
            className="image"
            alt="Students"
          />
        </div>
